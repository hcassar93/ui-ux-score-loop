...
- `.ui-ux-score-loop/flows/{flow-id}/data/state.json`: structured source of truth for that flow's view granularity, improvement intensity, iterations, view scores, rubric scores, and next target.
