...
1. Confirm the flow, URL or discoverable app environment, concerns, off-limits areas, one completion criterion, any custom viewports, any browser/tool preference, and whether light/dark mode is specified.
