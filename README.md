...
Start at the URL you provide. If you provide `/`, the loop begins at `/` and treats navigation into the flow as evidence. If you provide `/login`, it begins at `/login`.
